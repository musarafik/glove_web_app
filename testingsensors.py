...
while True:
	...
	for i in range(10):
		...
		MCP13.append(float("{:.5f}".format(mcp13_p4.voltage)))
		MCP13.append(float("{:.5f}".format(mcp13_p5.voltage)))
		MCP13.append(float("{:.5f}".format(mcp13_p6.voltage)))
		MCP13.append(float("{:.5f}".format(mcp13_p7.voltage)))
		# read imu acc
		get_IMU_values()
