...
while True:
	...
	for i in range(10):
		...
		MCP5.append(float("{:.5f}".format(mcp6_p0.voltage)))
		MCP5.append(float("{:.3f}".format(mcp6_p1.voltage)))
		MCP5.append(float("{:.2f}".format(mcp13_p1.voltage)))
		...
		MCP6.append(float("{:.5f}".format(mcp5_p3.voltage)))
		MCP6.append(float("{:.5f}".format(mcp5_p4.voltage)))
		MCP6.append(float("{:.5f}".format(mcp6_p4.voltage)))
		# read mcp13
		MCP13.append(float("{:.5f}".format(mcp6_p5.voltage)))
		MCP13.append(float("{:.5f}".format(mcp6_p6.voltage)))
		MCP13.append(float("{:.5f}".format(mcp6_p7.voltage)))
